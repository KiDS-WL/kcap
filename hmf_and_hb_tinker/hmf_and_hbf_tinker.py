...
def execute(block, config):
	...
	this_cosmo_run={"H0":block[cosmo_names, "hubble"], "Om0":block[cosmo_names, "omega_m"], "Ob0":block[cosmo_names, "omega_b"]}
	...
	for jz in range(0,nz):
		...
		mf.update(z=z_vec[jz], cosmo_params=this_cosmo_run, sigma_8=sigma_8, n=ns)
