...
if __name__ == "__main__":
    ...
    base_twopoint_file = "data/KiDS1000/mocks/noisefree_lens_dz_0.01/EE_nE_w_base/data/KiDS/twoPoint_PneE+PeeE_mean_None_cov_theoryBuceros_nOfZ_bucerosBroad_mock_noiseless.fits"
