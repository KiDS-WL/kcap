...
if __name__ == "__main__":
    ...
    parser.add_argument('--FMS-start-range', nargs=2, default=[0, 0], type=int, metavar=('BEGIN', 'END'), help='create noise-free configs w/ multinest start indexed by i with BEGIN <= i < END')
    ...
    for run_type in ['EE_nE_w']:
        ...
        for i in range(args.FMS_start_range[0], args.FMS_start_range[1]):
