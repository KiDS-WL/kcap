...
if __name__ == "__main__":
    ...
    if args.noise_free:
        ...
        dz_sabotage_settings = [
            "--set-parameters", "nofz_shifts", "p_3", "0.023",
            "--set-parameters", "nofz_shifts", "p_4", "0.012"
        ]
    ...
    KiDS_twopoint_file_sabo = f"runs/methodology/data/noisefree_fiducial/{data_name_root}_{run_type}/data/KiDS/twoPoint_PneE+PeeE_mean_None_cov_theoryEgrettaMCorr_nOfZ_bucerosBroad_mock_noiseless.fits" 
