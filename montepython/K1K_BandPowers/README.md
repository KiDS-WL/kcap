This folder contains the likelihood module for the KiDS-1000 (in short: K1K) cosmic shear band powers measurements from [K1K et al. 2020 (arXiv:20XX.YYYY)](http://adsabs.harvard.edu/abs/2020arXiv20XXYYYY).
