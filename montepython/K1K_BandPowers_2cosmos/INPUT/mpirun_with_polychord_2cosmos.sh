...
ncores=32
# set absolute path to the root folder of Monte Python '2cosmos' (usually 'montepython_2cosmos_public'):
mpirun -np $ncores python /your/path/to/montepython_2cosmos_public/montepython/MontePython.py run \
        `# supply relative path from working directory (wd) to param-file` \
	-p your/path/to/K1K_BandPowers_2cosmos/Theory_BandPowers_2cosmos.param \
